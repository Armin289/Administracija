 ...
 * @author armin
 */
public class Uredi_tabletController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        id_tableta = Funkcije.dohvatiIdTableta();
        ...
        try {
            postavi_artikal(id_tableta);
        } catch (IOException ex) {
            Logger.getLogger(Uredi_tabletController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void spremi(MouseEvent event) {
        ...
        if (aNaziv.equals("") || aCijena <= 0 || aGarancija.equals("") || aOpis.equals("") || aInterna_memorija.equals("") || aKapacitet_baterije.equals("") || aOperacijski_sustav.equals("") || aGlavna_kamera.equals("") || aPrednja_kamera.equals("")
            ...
            Artikal artikal = new Artikal(id_tableta, aNaziv, aCijena, aGarancija, aOpis, aInterna_memorija, aKapacitet_baterije,
                    aOperacijski_sustav, aGlavna_kamera, aEkran, aPrednja_kamera, aCpu, aRam, aSlika, aLink, aProizvodjac, aVrsta, aTip, aLogin_id);

            ArtikalService.artikalService.uredi(artikal);
            ponisti(event);
    ...
    private void obrisi_artikal(MouseEvent event) throws IOException {
        ...
        if (result.get() == ButtonType.OK) {
            ArtikalService.artikalService.brisi_saId(id_tableta);
