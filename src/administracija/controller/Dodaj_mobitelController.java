 ...
 * @author armin
 */
public class Dodaj_mobitelController implements Initializable {
    ...
    public void spremi(MouseEvent event) {
        ...
        if (aNaziv.equals("") || aCijena <= 0 || aGarancija.equals("") || aOpis.equals("") || aInterna_memorija.equals("") || aKapacitet_baterije.equals("") || aOperacijski_sustav.equals("") || aGlavna_kamera.equals("") || aPrednja_kamera.equals("")
                || aEkran.equals("") || aCpu.equals("") || aRam.equals("") || aLink.equals("") || aProizvodjac.equals("") || slika_string.equals("") || aVrsta.equals("") || aTip.equals("")) {
